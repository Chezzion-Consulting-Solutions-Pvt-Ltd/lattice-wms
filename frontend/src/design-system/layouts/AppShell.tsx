...
const clientNavItems = [
  ...
  { label: 'Bays', icon: Database, href: '/tenant/bays' },
  { label: 'Holding Units', icon: Boxes, href: '/tenant/configuration/holding-units' },
  { label: 'Pallets', icon: Boxes, href: '/tenant/configuration/pallets' },
  { label: 'Machines', icon: Database, href: '/tenant/configuration/machines' },
  { label: 'Resources', icon: Users, href: '/tenant/configuration/resources' },
  { label: 'SKU Groups', icon: Boxes, href: '/tenant/configuration/sku-groups' },
  { label: 'Inventory Categories', icon: Boxes, href: '/tenant/configuration/inventory-categories' },
  { label: 'Operations', icon: ClipboardList, href: '/tenant/configuration/operations' },
  { label: 'Missions', icon: ClipboardList, href: '/tenant/configuration/missions' },
  { label: 'Mission Groups', icon: ClipboardList, href: '/tenant/configuration/mission-groups' },
  { label: 'Zone Queues', icon: Database, href: '/tenant/configuration/zone-queues' },
  { label: 'Sequences', icon: KeyRound, href: '/tenant/configuration/sequences' },
  { label: 'Statuses', icon: Shield, href: '/tenant/configuration/statuses' },
  { label: 'Transport', icon: Warehouse, href: '/tenant/configuration/transport' },
  { label: 'Warehouse Control', icon: Settings, href: '/tenant/configuration/warehouse-control' },
  { label: 'Hierarchy', icon: Boxes, href: '/tenant/hierarchy' },
  { label: 'Users', icon: Users, href: '/tenant/users' },
  { label: 'Roles', icon: Shield, href: '/tenant/roles' },
  { label: 'Assignments', icon: Shield, href: '/tenant/warehouse-assignments' },
